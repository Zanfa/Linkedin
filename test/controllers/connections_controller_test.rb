...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { first_name: @connection.first_name, headline: @connection.headline, last_name: @connection.last_name }
    end
  ...
  test "should update connection" do
    patch :update, id: @connection, connection: { first_name: @connection.first_name, headline: @connection.headline, last_name: @connection.last_name }
    assert_redirected_to connection_path(assigns(:connection))
  end
